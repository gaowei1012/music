...
function (_Nerv$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function componentUnMount() {
      ...
      this.inputRef.removeEventListener('input', function (e) {
        _newArrowCheck(this, _this3);
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          confirmType = _this$props$confirmTy === void 0 ? '' : _this$props$confirmTy,
  ...
  _createClass(Tabbar, [{
    ...
    value: function getCurrentPathname() {
      ...
      if (this.props.mode === 'hash') {
        ...
        pathname = location.pathname.replace(new RegExp("^".concat(this.props.publicPath, "/?")), '');
      }
